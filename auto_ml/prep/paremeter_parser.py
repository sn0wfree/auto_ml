...
rgs_translation = {'svr': 'svr', 'knn_regression': 'knn', 'ada_boost_regression': 'ada_boost',
                   'gradient_boosting_regression': 'gradient_boosting',
                   'random_forest_regression': 'random_forest',
                   'extra_trees_regression': 'extra_trees',
                   'sgd_regression': 'sgd', 'xgboost_regression': 'xgboost'}

clf_translation ={}
class ParametersHolder(object):
    Regressors = ['svr',  # 'svr_linear', 'svr_rbf','svr_poly', 'svr_sigmoid',
    ...
    Classifiers = ['svc',  # 'svc_linear', 'svc_rbf', 'svc_poly','svc_sigmoid', 'liblinear_svc',
...
class Parser(object):
    ...
    def check_translate(cls, name, translate_type='rgs', printout=False):
        ...
        :return:
        """
        real_name = globals()[f'{translate_type}_translation'][name]
        if real_name in getattr(cls, f'translate_{translate_type}')():
            if printout:
